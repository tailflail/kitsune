...
ActiveRecord::Schema[7.0].define(version: 2023_03_07_130108) do
  ...
  create_table "profiles", force: :cascade do |t|
    t.string "short_biography", default: ""
    t.string "long_biography", default: ""
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "sanitized_short_biography", default: ""
    t.string "sanitized_long_biography", default: ""
